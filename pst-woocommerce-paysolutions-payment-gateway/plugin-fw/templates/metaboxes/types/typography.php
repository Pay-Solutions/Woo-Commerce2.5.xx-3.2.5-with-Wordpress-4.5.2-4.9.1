            ...
            <?php if ( strpos( $style['properties'], 'font-size' ) !== false ) : ?>
                ...
                <div class="select_wrapper font-unit">
                    <select name="<?php echo $name ?>[unit]" id="<?php echo $id ?>-unit">
                        <option value="px" <?php selected( $value['unit'], 'px' ) ?>><?php _e( 'px', 'pst' ) ?></option>
                        <option value="em" <?php selected( $value['unit'], 'em' ) ?>><?php _e( 'em', 'pst' ) ?></option>
                        <option value="pt" <?php selected( $value['unit'], 'pt' ) ?>><?php _e( 'pt', 'pst' ) ?></option>
                        <option value="rem" <?php selected( $value['unit'], 'rem' ) ?>><?php _e( 'rem', 'pst' ) ?></option>
                    </select>
                </div>
            <?php endif; ?>
            ...
            <?php if ( strpos( $style['properties'], 'font-family' ) !== false ) : ?>
                ...
                <div class="select_wrapper font-family">
                    <select name="<?php echo $name ?>[family]" id="<?php echo $id ?>-family">
                        <?php
                        $web_fonts = pst_get_web_fonts();
                        $google_fonts = pst_get_google_fonts();

                        if ( ! empty( $web_fonts ) ) {
                            echo '<optgroup label="' . __( 'Web fonts', 'pst' ) . '">';
                        ...
                        if ( ! empty( $google_fonts ) ) {
                            echo '<optgroup label="' . __( 'Google fonts', 'pst' ) . '">';
            ...
            <?php if ( strpos( $style['properties'], 'font-style' ) !== false ) : ?>
                ...
                <div class="select_wrapper font-style">
                    <select name="<?php echo $name ?>[style]" id="<?php echo $id ?>-style">
                        <option value="regular" <?php selected( $value['style'], 'regular' ) ?>><?php _e( 'Regular', 'pst' ) ?></option>
                        <option value="bold" <?php selected( $value['style'], 'bold' ) ?>><?php _e( 'Bold', 'pst' ) ?></option>
                        <option value="extra-bold" <?php selected( $std['style'], 'extra-bold' ) ?>><?php _e( 'Extra bold', 'pst' ) ?></option>
                        <option value="italic" <?php selected( $value['style'], 'italic' ) ?>><?php _e( 'Italic', 'pst' ) ?></option>
                        <option value="bold-italic" <?php selected( $value['style'], 'bold-italic' ) ?>><?php _e( 'Italic bold', 'pst' ) ?></option>
                    </select>
                </div>
            <?php endif; ?>
