...
<div class="pst-sidebar-layout">
    <div class="option">
        ...
        <img src="<?php echo PST_CORE_PLUGIN_URL ?>/assets/images/sidebar-left.png" title="<?php _e( 'Left sidebar', 'pst' ) ?>" alt="<?php _e( 'Left sidebar', 'pst' ) ?>" class="<?php echo $id . '-left' ?>" />

        <input type="radio" name="<?php echo  $name ?>[layout]" id="<?php echo $id . '-right' ?>" value="sidebar-right" <?php checked( $layout, 'sidebar-right' ) ?> />
        <img src="<?php echo PST_CORE_PLUGIN_URL ?>/assets/images/sidebar-right.png" title="<?php _e( 'Right sidebar', 'pst' ) ?>" alt="<?php _e( 'Right sidebar', 'pst' ) ?>" class="<?php echo $id . '-right' ?>" />

        <input type="radio" name="<?php echo  $name ?>[layout]" id="<?php echo $id . '-double' ?>" value="sidebar-double" <?php checked( $layout, 'sidebar-double' ) ?> />
        <img src="<?php echo PST_CORE_PLUGIN_URL ?>/assets/images/double-sidebar.png" title="<?php _e( 'No sidebar', 'pst' ) ?>" alt="<?php _e( 'No sidebar', 'pst' ) ?>" class="<?php echo $id . '-double' ?>" />

        <input type="radio" name="<?php echo  $name ?>[layout]" id="<?php echo $id . '-no' ?>" value="sidebar-no" <?php checked( $layout, 'sidebar-no' ) ?> />
        <img src="<?php echo PST_CORE_PLUGIN_URL ?>/assets/images/no-sidebar.png" title="<?php _e( 'No sidebar', 'pst' ) ?>" alt="<?php _e( 'No sidebar', 'pst' ) ?>" class="<?php echo $id . '-no' ?>" />
    </div>
    ...
    <div class="option" id="choose-sidebars">
        <div class="side">
            <div class="select-mask" <?php if ( $layout != 'sidebar-double' && $layout != 'sidebar-left' ) { echo 'style="display:none"'; } ?> id="<?php echo $id ?>-sidebar-left-container">
                <label for ="<?php echo $id ?>-sidebar-left"><?php _e('Left Sidebar','pst') ?></label>
        ...
        <div class="side"  style="clear: both">
            <div class="select-mask"  <?php if ( $layout != 'sidebar-double' && $layout != 'sidebar-right' ) { echo 'style="display:none"'; } ?> id="<?php echo $id ?>-sidebar-right-container">
                <label for ="<?php echo $id ?>-sidebar-right"><?php _e('Right Sidebar','pst') ?></label>
...
<script type="text/javascript">
    (function ($){
        ...
        $(document).on('click', '.pst-sidebar-layout img' , function(e) {
...
//
//        $(document).on('click', '.pst-sidebar-layout img' , function() {
//
//            $( this ).parent().children( ':radio' ).attr( 'checked', false );
//            $( this ).prev( ':radio' ).attr( 'checked', true );
//        });
