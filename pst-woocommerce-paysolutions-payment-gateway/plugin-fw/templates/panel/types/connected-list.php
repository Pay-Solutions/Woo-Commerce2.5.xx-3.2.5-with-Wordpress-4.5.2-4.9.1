...
<div id="<?php echo $id ?>-container" class="pst_options rm_option rm_input rm_text rm_connectedlist" <?php if( isset( $option['deps'] ) ): ?>data-field="<?php echo $id ?>" data-dep="<?php echo $this->get_id_field( $option['deps']['ids'] ) ?>" data-value="<?php echo $option['deps']['values'] ?>" <?php endif ?>>
    <div class="option">
        <?php $pst_option = json_decode( stripslashes( $db_value ), true ); ?>
        <?php $lists = is_array($pst_option) ? $pst_option : $option['lists']; ?>
