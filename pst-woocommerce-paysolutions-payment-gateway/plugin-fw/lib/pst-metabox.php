...
if ( ! class_exists( 'PST_Metabox' ) ) {
     ...
     *                          'fields' => array(
     *                          'meta_checkbox' => array(
     *                                 'label'    => __( 'Show title', 'pst' ),
     *                                 'desc'     => __( 'Show title of the page or not.', 'pst' ),
     *                                 'type'     => 'checkbox',
     *                                 'private'  => false,
     *                                 'std'      => '1'),
     *                            ),
     ...
     *  );
     *
     * $metabox1 = PST_Metabox( 'pst-metabox-id' );
     * $metabox1->init( $args );
     * </code>
     *
     * @class PST_Metaboxes
    ...
    class PST_Metabox {
        ...
        public function enqueue() {
            ...
            wp_enqueue_style( 'pst-plugin-metaboxes', PST_CORE_PLUGIN_URL . '/assets/css/metaboxes.css' );
            wp_enqueue_style( 'jquery-chosen', PST_CORE_PLUGIN_URL . '/assets/css/chosen/chosen.css' );
            wp_enqueue_script( 'jquery-ui-datepicker' );
            wp_enqueue_script( 'pst-spinner', PST_CORE_PLUGIN_URL . '/assets/js/panel.spinner.js', array( 'jquery' ), '0.0.1', true );
            wp_enqueue_script( 'jquery-chosen', PST_CORE_PLUGIN_URL . '/assets/js/chosen/chosen.jquery.js', array( 'jquery' ), '1.1.0', true );
            wp_enqueue_script( 'pst-metabox', PST_CORE_PLUGIN_URL . '/assets/js/metabox.js', array( 'jquery', 'wp-color-picker' ), '1.0.0', true );
        ...
        public function get_option_metabox_name( $id_field, $private = true ) {
            $db_name = apply_filters( 'pst_metaboxes_option_main_name', 'pst_metaboxes' );
            $return  = $db_name . '[';
        ...
        public function show() {
            ...
            pst_plugin_get_template( PST_CORE_PLUGIN_PATH, 'metaboxes/tab.php', array( 'tabs' => $this->tabs ) );
        }
        ...
        public function save_postdata( $post_id ) {
            ...
            if ( ! isset( $_POST['pst_metaboxes_nonce'] ) || ! wp_verify_nonce( $_POST['pst_metaboxes_nonce'], 'metaboxes-fields-nonce' ) ) {
                return $post_id;
            }
            ...
            foreach ( $this->tabs as $tab ) {
                ...
                foreach ( $tab['fields'] as $field ) {
                    ...
                    if ( isset( $_POST['pst_metaboxes'][$field['id']] ) ) {

                        add_post_meta( $post_id, $field['id'], $_POST['pst_metaboxes'][$field['id']], true ) || update_post_meta( $post_id, $field['id'], $_POST['pst_metaboxes'][$field['id']] );
                    }
...
if ( ! function_exists( 'PST_Metabox' ) ) {
    ...
    function PST_Metabox( $id ) {
        return PST_Metabox::instance( $id );
    }
}
