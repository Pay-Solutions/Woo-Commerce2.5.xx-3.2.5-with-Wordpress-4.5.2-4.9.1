...
if ( ! class_exists( 'PST_Gradients' ) ) {
    ...
    class PST_Gradients {
        ...
        public function getModel( $class ) {
            return PST_Registry::get_instance()->$class;
        }
        ...
        public function __get( $name ) {
            if ( $name == 'request' ) {
                if ( ! $this->_request instanceof PST_Request ) {
                    $this->_request = PST_Registry::get_instance()->request;
                }
