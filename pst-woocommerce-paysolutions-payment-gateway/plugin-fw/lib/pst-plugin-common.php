...
if ( ! class_exists( 'PST_Plugin_Common' ) ) :
...
class PST_Plugin_Common {
    ...
    public function init() {
        self::$_config['header_backgrounds'] = apply_filters( 'pst_header_backgrounds', self::$_config['header_backgrounds'] );
        self::$_config['body_backgrounds']   = apply_filters( 'pst_body_backgrounds', self::$_config['body_backgrounds'] );
    }
    ...
    public static function get_icon_list() {
        ...
        return apply_filters( 'pst_icon_list', $standard_icon_list );
    }
