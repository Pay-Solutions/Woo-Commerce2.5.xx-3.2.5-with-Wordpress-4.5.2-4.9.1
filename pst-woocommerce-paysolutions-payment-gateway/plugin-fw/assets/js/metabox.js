...
(function ($) {
    ...
    $(act_page_option).insertAfter('#pst-post-setting .handlediv');
    $(act_page_option).insertAfter('#pst-page-setting .handlediv');


    $('#_active_page_options-container').on('click', function(){
        if( $('#_active_page_options').is(":checked") ){
            $('#pst-page-setting .inside .metaboxes-tab, #pst-post-setting .inside .metaboxes-tab').css( { 'opacity' : 1 , 'pointer-events' : 'auto' } );
        }else{
            $('#pst-page-setting .inside .metaboxes-tab, #pst-post-setting .inside .metaboxes-tab').css( { 'opacity' : 0.5 , 'pointer-events' : 'none' } );
        }
    }).click();
